...
import net.ncraft.client.renderer.culling.ICamera;
import net.ncraft.client.texture.Texture;
import net.ncraft.entity.Entity;
import net.ncraft.entity.EntityBubbleFX;
import net.ncraft.entity.EntityExplodeFX;
import net.ncraft.entity.EntityFlameFX;
import net.ncraft.entity.EntityLavaFX;
import net.ncraft.entity.EntityPlayer;
import net.ncraft.entity.EntityPlayerSP;
import net.ncraft.entity.EntitySmokeFX;
import net.ncraft.entity.EntitySorter;
import net.ncraft.entity.EntitySplashFX;
import net.ncraft.fi;
import net.ncraft.item.ItemStack;
import net.ncraft.tileentity.TileEntity;
import net.ncraft.tileentity.TileEntityRenderer;
import net.ncraft.util.AxisAlignedBB;
import net.ncraft.util.MathHelper;
import net.ncraft.util.Vec3D;
import net.ncraft.world.IWorldAccess;
...
public class RenderGlobal implements IWorldAccess {
    ...
    public void renderClouds(final float float1) {
        ...
        GL11.glDisable(2884);
        final float n = (float) (this.t.thePlayer.lastTickPosY + (this.t.thePlayer.posY - this.t.thePlayer.lastTickPosY) * float1);
        final int n2 = 32;
        final int n3 = 256 / n2;
        final Tessellator instance = Tessellator.instance;
