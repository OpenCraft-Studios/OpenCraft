...
import net.ncraft.client.gui.options.GuiControls;
import net.ncraft.client.gui.options.GuiMusicAndSounds;
import net.ncraft.client.gui.options.GuiVideoSettings;
