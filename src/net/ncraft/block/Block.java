...
import net.ncraft.client.sound.StepSound;
import net.ncraft.client.sound.StepSoundSand;
import net.ncraft.client.sound.StepSoundStone;
...
import net.ncraft.item.ItemBlock;
