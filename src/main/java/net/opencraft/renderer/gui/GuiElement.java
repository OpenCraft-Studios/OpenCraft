...
public class GuiElement {
	...
	protected void drawGradientRect(final int integer1, final int integer2, final int integer3, final int integer4,
		...
		t.beginQuads();
		{
			t.color(float5, float6, float7, float4);
			t.vertex(integer3, integer2, 0.0);
			t.vertex(integer1, integer2, 0.0);

			t.color(float9, float10, float11, float8);
			t.vertex(integer1, integer4, 0.0);
			t.vertex(integer3, integer4, 0.0);
		}
		t.render();
		GL11.glDisable(3042);
		GL11.glEnable(3008);
	...
	public void drawCenteredString(final FontRenderer ej, final String string, final int integer3, final int integer4,
			final int integer5) {
		ej.drawShadow(string, integer3 - ej.width(string) / 2, integer4, integer5);
	}

	public void drawString(final FontRenderer fontRenderer, final String string, final int xCoord, final int yCoord,
