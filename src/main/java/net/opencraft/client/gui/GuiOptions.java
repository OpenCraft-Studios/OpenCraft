...
import net.opencraft.client.gui.options.GuiControls;
import net.opencraft.client.gui.options.GuiMusicAndSounds;
import net.opencraft.client.gui.options.GuiVideoSettings;
