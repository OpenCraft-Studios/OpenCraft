...
import net.opencraft.client.texture.Texture;
import net.opencraft.entity.Entity;
import net.opencraft.entity.EntityBubbleFX;
import net.opencraft.entity.EntityExplodeFX;
import net.opencraft.entity.EntityFlameFX;
import net.opencraft.entity.EntityLavaFX;
import net.opencraft.entity.EntityPlayer;
import net.opencraft.entity.EntityPlayerSP;
import net.opencraft.entity.EntitySmokeFX;
import net.opencraft.entity.EntitySorter;
...
public class RenderGlobal implements IWorldAccess {
    ...
    public RenderGlobal(final OpenCraft aw, final RenderEngine id) {
