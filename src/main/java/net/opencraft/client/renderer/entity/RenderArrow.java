...
public class RenderArrow extends Render<EntityArrow> {
    ...
    public void doRender(EntityArrow entityLiving, double xCoord, double sqrt_double, double yCoord, float nya1, float nya2) {
        ...
        ag2.beginQuads();
        ag2.vertexUV(-7.0, -2.0, -2.0, f7, f9);
        ag2.vertexUV(-7.0, -2.0, 2.0, f8, f9);
        ag2.vertexUV(-7.0, 2.0, 2.0, f8, f10);
        ag2.vertexUV(-7.0, 2.0, -2.0, f7, f10);
        ag2.draw();
        GL11.glNormal3f((float) (-f11), (float) 0.0f, (float) 0.0f);
        ag2.beginQuads();
        ag2.vertexUV(-7.0, 2.0, -2.0, f7, f9);
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            ag2.beginQuads();
            ag2.vertexUV(-8.0, -2.0, 0.0, f3, f5);
            ag2.vertexUV(8.0, -2.0, 0.0, f4, f5);
            ag2.vertexUV(8.0, 2.0, 0.0, f4, f6);
            ag2.vertexUV(-8.0, 2.0, 0.0, f3, f6);
            ag2.draw();
        }
