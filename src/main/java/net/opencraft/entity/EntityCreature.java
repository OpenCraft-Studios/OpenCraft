...
public class EntityCreature extends EntityLiving {
	...
	protected boolean canEntityBeSeen(final Entity entity) {
		return this.world.raycastBlocks(Vec3.newTemp(this.x, this.y + this.getEyeHeight(), this.z), Vec3.newTemp(entity.x, entity.y + entity.getEyeHeight(), entity.z)) == null;
	}
	...
	protected void updatePlayerActionState() {
		...
		int floor_double = Mth.floor_double(this.bb.minY);
		...
		if (vec3D != null) {
			...
			this.yRot = (float) (toRadians(atan2(n4, n3))) - 90.0f;
			...
			if (this.hasAttacked && this.playerToAttack != null) {
				...
				this.yRot = (float) (toRadians(atan2(n7, n6))) - 90.0f;
				final float n8 = toRadians(rotationYaw - this.yRot + 90.0f);
